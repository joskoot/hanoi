...
;=====================================================================================================
; Mutable state of the game. Kept at top level for easy accessibility.
; Will be initialized before starting the gsme.
...
; as signal to exit from the action without resetting or quitting)
