...
(define (size-of-top-disk p) ; An empty peg always has an imiginary greater disk at top.
...
(define (action-manual1 d h p)
  ...
  (dispatch-button pos
    ...
    (else
      ...
      (cond
        (dest (action-manual2 d h p dest)) ; Use manual2 to try to move to peg dest.
